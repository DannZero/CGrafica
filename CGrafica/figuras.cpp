...
void CFiguras::skybox(float largo, float altura, float profundidad, GLuint text)  //Funcion creacion cielo
{
	...
	GLfloat vertice [8][3] = {
				{0.5f*largo ,-0.5f*altura, 0.5f*profundidad},    //Coordenadas VŽrtice 1 V1
				{-0.5f*largo ,-0.5f*altura , 0.5f*profundidad},    //Coordenadas VŽrtice 2 V2
				{-0.5f*largo ,-0.5f*altura , -0.5f*profundidad},    //Coordenadas VŽrtice 3 V3
				{0.5f*largo ,-0.5f*altura , -0.5f*profundidad},    //Coordenadas VŽrtice 4 V4
				{0.5f*largo ,0.5f*altura , 0.5f*profundidad},    //Coordenadas VŽrtice 5 V5
				{0.5f*largo ,0.5f*altura , -0.5f*profundidad},    //Coordenadas VŽrtice 6 V6
				{-0.5f*largo ,0.5f*altura , -0.5f*profundidad},    //Coordenadas VŽrtice 7 V7
				{-0.5f*largo ,0.5f*altura , 0.5f*profundidad},    //Coordenadas VŽrtice 8 V8
				};
...
void CFiguras::prisma2 (GLuint text, GLuint text2)  //Funcion creacion prisma
{
	...
	GLfloat vertice [8][3] = {
				{0.5 ,-0.5, 0.5},    //Coordenadas VŽrtice 0 V0
				{-0.5 ,-0.5, 0.5},    //Coordenadas VŽrtice 1 V1
				{-0.5 ,-0.5, -0.5},    //Coordenadas VŽrtice 2 V2
				{0.5 ,-0.5, -0.5},    //Coordenadas VŽrtice 3 V3
				{0.5 ,0.5, 0.5},    //Coordenadas VŽrtice 4 V4
				{0.5 ,0.5, -0.5},    //Coordenadas VŽrtice 5 V5
				{-0.5 ,0.5, -0.5},    //Coordenadas VŽrtice 6 V6
				{-0.5 ,0.5, 0.5},    //Coordenadas VŽrtice 7 V7
				};
